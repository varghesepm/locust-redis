...
class RedisSentinelTaskSet(TaskSet):
    ...
    def get_redis_sentinel_info(self):
        ...
        namespace = "antelope-int"  # Change this to your Kubernetes namespace
    ...
    def get_master(self):
        self.master = self.sentinel.sentinel_master("int-redis-tester-announce-0")  # Change this to your master service name
        return self.master
